...
describe('utility methods', function() {
  ...
  describe('isValidAPI()', function() {
    ...
    it('should consider keys shorter than 20 chars as invalid', function() {
      expect(utils.isValidApiKey('1234567890123456789')).to.be.false;
    });

    it('should consider keys longer than 20 chars as invalid', function() {
      expect(utils.isValidApiKey('123456789012345678901')).to.be.false;
    });

    it('should consider keys with non-alpha chars as invalid', function() {
  ...
  describe('validateNumber()', function() {
    ...
    describe('valid mobile phone # w/o space/dash/dot separators', function() {
      ...
      it('should return normalized # with 0 prefix', function() {
        expect(utils.validateNumber('09995551212')).to.equal('09995551212');
      });

      it('should return normalized # with 63 prefix', function() {
    ...
    describe('valid mobile phone numbers using dash separators', function() {
      ...
      it('should return normalized # with +63 prefix', function() {
        expect(utils.validateNumber('+63-999-555-1212'))
          .to.equal('09995551212');
      });
    });
